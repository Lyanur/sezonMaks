...
class AkciiSuperKaruselNew extends StatefulWidget {
  const AkciiSuperKaruselNew(
      {Key key, this.animationController, this.areaListData, this.animation})
      : super(key: key);
  ...
  final Animation<dynamic> animation;
  @override
  _AkciiSuperKaruselNewState createState() => _AkciiSuperKaruselNewState();
}

class _AkciiSuperKaruselNewState extends State<AkciiSuperKaruselNew>
    with TickerProviderStateMixin {
  AnimationController animationController;
  List<String> areaListData;
                          ...
                          child: GestureDetector(
                              ...
                              child: Card(
                                  ...
                                  child: Stack(children: [
                                    Image.asset(
                                      'assets/akcii/' +
                                          widget.areaListData[index].type +
                                          '.jpg',
                                      // fit: BoxFit.fitWidth,
                                    ),
                                    Container(
                            ...
                            child: ClipRRect(
                                ...
                                child: Stack(children: [
                                  ...
                                  Positioned(
                                      ...
                                      top: 60,
                                      child: Text(
                                        widget.areaListData[index].price,
                                        style: TextStyle(
                                          fontFamily: "Roboto",
                                          fontWeight: FontWeight.w700,
                                          fontSize: 24,
                                  ...
                                  Positioned(
                                      ...
                                      top: 88,
                                      child: Text(
                                        widget.areaListData[index].title,
                                        style: TextStyle(
                                          fontFamily: "Roboto",
                                          fontWeight: FontWeight.w700,
                                          fontSize: 10,
...
class ImageDialog extends StatelessWidget {
  const ImageDialog({Key key, this.imagepath}) : super(key: key);
              ...
              placeholder: (context, url) => Container(
                  ...
                  child: Theme(
                    ...
                    child: CircularProgressIndicator(
                      valueColor:
                      new AlwaysStoppedAnimation<Color>(Colors.grey[100]),
                      strokeWidth: 1.0,
                    ),
                  ))),
        ));
