            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: SezonAppTheme.sezonMain.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      SezonAppTheme.sezonMain.withOpacity(0.2),
                      SezonAppTheme.sezonMain.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      SezonAppTheme.sezonMain.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: SezonAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: SezonAppTheme.white.withOpacity(
