...
class BottomBarView extends StatefulWidget {
  const BottomBarView(
      {Key key, this.tabIconsList, this.changeIndex, this.addClick, this.callback})
      : super(key: key);
  ...
  @override
  _BottomBarViewState createState() => _BottomBarViewState(callback);
}
...
class _BottomBarViewState extends State<BottomBarView>
  ...
  _BottomBarViewState(Function() callback) {
